...
#pragma warning restore 618
    {
        ...
        public void SpawnAnchor(Vector3 position, Quaternion rotation, Component anchor)
        {
            ...
            anchorObject.transform.Rotate(-90, -90, 0);
            Debug.Log("position of anchor:" + anchorObject.transform.position);
            

            

            //Debug.Log("position of puck: " + puck1.transform.position);
            //Debug.Log("puck active:?" + puck.activeSelf);
            //Debug.Log("puck info " + puck.transform.localToWorldMatrix);
