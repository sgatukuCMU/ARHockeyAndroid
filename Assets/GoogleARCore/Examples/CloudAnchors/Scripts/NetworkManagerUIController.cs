...
#pragma warning restore 618
        ...
        public void OnAnchorHosted(bool success, string response)
        {
            if (success)
            {
                ...
                PhotonManagerObject.SetActive(true);
            }
            else
            {
...
#pragma warning restore 618
        {
            ...
            if (m_Manager.matches != null)
            {
                ...
                NoPreviousRoomsText.gameObject.SetActive(true);
                if (m_Manager.matches.Count != 0)
                    NoPreviousRoomsText.text = "This is a 2 player Augmented Reality air hockey game \nPlayer 1 create a room with the + button \nPlayer 2 join the room created \nPlayer 1 is green.Player 2 is blue. \nFound Rooms! ";
